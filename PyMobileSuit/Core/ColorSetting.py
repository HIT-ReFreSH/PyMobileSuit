...
class IColorSetting(ABC):
    ...
    @staticmethod
    def DefaultColorSetting() -> IColorSetting:
    ...
    @staticmethod
    def SelectColor(colorSetting, type: OutputType = OutputType.Default, customColor: Optional[Color] = None) -> Color:
...
class ColorSetting(IColorSetting):
    ...
    def __init__(self, BackgroundColor: Color, DefaultColor: Color, PromptColor: Color, ErrorColor: Color, OkColor: Color, TitleColor: Color, InformationColor: Color, SystemColor: Color, WarningColor: Color):
    ...
    def __hash__(self) -> int:
        ...
        """
        return hash((self.DefaultColor, self.PromptColor, self.ErrorColor, self.OkColor, self.TitleColor, self.InformationColor, self.SystemColor, self.WarningColor, self.BackgroundColor))
